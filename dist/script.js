...
/* harmony import */ var _modules_diffrerenceList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/diffrerenceList */ "./src/js/modules/diffrerenceList.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form */ "./src/js/modules/form.js");
/* harmony import */ var _modules_moduleInfoShow__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/moduleInfoShow */ "./src/js/modules/moduleInfoShow.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var mainSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    //новый экземпляр класса
    btns: '.next',
    container: '.page'
  });
  mainSlider.render();
  var moduleMainSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    //новый экземпляр класса
    btns: '.next',
    container: '.moduleapp'
  });
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__video .play', '.overlay').init();
  var differenceListOld = new _modules_diffrerenceList__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold');
  differenceListOld.init();
  var differenceListNew = new _modules_diffrerenceList__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew');
  differenceListNew.init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').bindPostDats();
  new _modules_moduleInfoShow__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info-show .plus').showtext();
});

/***/ }),

/***/ "./src/js/modules/diffrerenceList.js":
/*!*******************************************!*\
  !*** ./src/js/modules/diffrerenceList.js ***!
  \*******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DifferenceList; });
...
/*#__PURE__*/
function () {
  function DifferenceList(parentSelector) {
    _classCallCheck(this, DifferenceList);
  ...
  _createClass(DifferenceList, [{
    key: "hideCard",
    value: function hideCard() {
      this.cards.forEach(function (card) {
        if (!card.lastElementChild.matches('div .card__click') && !card.matches('.officer__card-title')) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "bindPostDats",
    value: function bindPostDats() {
      var _this = this;

      this.checkMailInputs();
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          e.preventDefault(); // img for loading:

          var statusMessage = document.createElement('img');
          statusMessage.src = _this.message.loading;
          statusMessage.style.cssText = "position: absolute;\n                                               right: 180px;\n                                               bottom: 30px;\n                                               width: 150px;\n                                               height: 150px;                    \n                                            ";
          form.parentNode.appendChild(statusMessage); // div for status message:

          var statusMessageDone = document.createElement('div');
          statusMessageDone.style.cssText = "\n                           margin-top: 15px;\n                           color : grey;\n                           font-size: 30px;\n        ";
          form.insertAdjacentElement('afterend', statusMessageDone);
          statusMessageDone.textContent = _this.message.ladingtext;
          var formData = new FormData(form); // принимает данные с формы

          var json = JSON.stringify(Object.fromEntries(formData.entries())); // в json

          _this.postData("https://631d8c8fcc652771a4875497.mockapi.io/getForm", json).then(function (data) {
            console.log(data);
            statusMessageDone.textContent = _this.message.success;
            statusMessage.remove();
          }).catch(function () {
            statusMessageDone.textContent = _this.message.failure;
          }).finally(function () {
            form.reset();
            setTimeout(function () {
...
/***/ "./src/js/modules/moduleInfoShow.js":
/*!******************************************!*\
  !*** ./src/js/modules/moduleInfoShow.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModuleInfoShow; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function ModuleInfoShow(trigger) {
    _classCallCheck(this, ModuleInfoShow);

    this.btns = document.querySelectorAll(trigger);
  }

  _createClass(ModuleInfoShow, [{
    key: "showtext",
    value: function showtext() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          sibling.classList.add('fadeInDown'); // if (this.text.style.display == "block") {
  ...
  _createClass(VideoPlayer, [{
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            _this.activeBtn = btn; // if player was created , just use method: loadVideoById API with new path
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              _this.path = btn.getAttribute('data-url'); //creat property for link video

              _this.createPlayer(_this.path); //create player when 1-st play
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function () {
        ...
        _this2.player.stopVideo(); // method 
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides() {
      ...
      try {
        var divHanson = this.slides[2].querySelector('.hanson');
    ...
    value: function render() {
      if (this.container) {
        //условие что действие происходит именно на данной странице
        this.bindTriggers();
        this.showSlides();
      }
    }
