...
function () {
  ...
  _createClass(VideoPlayer, [{
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          if (document.querySelector('iframe#frame')) {
            // div меняется на iframe при первой загрузке видео
            _this.overlay.style.display = 'flex';
          } else {
            var path = btn.getAttribute('data-url'); //ссылка это значение атрибута на каждой кнопке
    ...
    key: "init",
    value: function init() {
      // подключение скрипта из youtube API
